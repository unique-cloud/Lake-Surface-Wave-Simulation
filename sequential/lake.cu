...
void evolve5pt(double* un, double* uc, double* uo, double* pebbles, int n, double h, double dt, double t);
...
void evolve(double* un, double* uc, double* uo, double* pebbles, int n, double h, double dt, double t, int PT) {
    int i, j, idx;
...
void evolve5pt(double* un, double* uc, double* uo, double* pebbles, int n, double h, double dt, double t) { evolve(un, uc, uo, pebbles, n, h, dt, t, PT5); }
void evolve9pt(double* un, double* uc, double* uo, double* pebbles, int n, double h, double dt, double t) { evolve(un, uc, uo, pebbles, n, h, dt, t, PT9); }
